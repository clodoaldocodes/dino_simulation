...
DUCKING = [pygame.image.load(os.path.join("D:\dino_simulation\Assets\Dino", "DinoDuck1.png")),
...
class Bird(Obstacle):
    def __init__(self, image, number_of_cacti=0):
        super().__init__(image, number_of_cacti=0)
        self.rect.y = 250
        self.index = 0
    ...
    while run:
        ...
        if len(obstacles) == 0:
            ...
            if rand_int == 0:
                ...
                obstacles.append(LargeCactus(LARGE_CARTUS, random.randint(0, 2)))
        ...
        for i, dinosaur in enumerate(dinosaurs):
            ...
            if output[0] > 0.6 and dinosaur.rect.y == dinosaur.Y_POS:
                dinosaur.dino_jump = True
                dinosaur.dino_run = False
                dinosaur.dino_duck = False
            elif output[1] > 0.6 and dinosaur.rect.y == dinosaur.Y_POS:
